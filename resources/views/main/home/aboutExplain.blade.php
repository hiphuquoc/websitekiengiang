<div class="aboutExplainBox">
    {{-- <div class="aboutExplainBox_image">
        <img src="https://tamnguyen.com.vn/hinhanh/tintuc/thietkewebdulichchuyennghiep1.jpg" alt="thiết kế Website chuẩn seo kiên giang" title="thiết kế Website chuẩn seo kiên giang" />
    </div> --}}
        ...
        <div class="aboutExplainBox_content_text">
            ...
            <div class="aboutExplainBox_content_text_column">
                ...
                <div class="aboutExplainBox_content_text_column_text effectBottomToTop">
                    ...
                    <blockquote id="chinh-sach-bao-hanh-phat-trien-tinh-nang-website-kien-giang" cite="{{ URL::current() }}?chinh-sach-bao-hanh-phat-trien-tinh-nang-website-kien-giang">
                        Nếu đã là khách hàng của <strong>Thiết kế Website Kiên Giang</strong> thì ngoại trừ việc được bảo trì - bảo hành Website trọn đời bạn còn được miễn phí phát triển các tính năng đơn giản sau này.<br/>
                        Đối với các tính năng lớn, phức tạp, mất nhiều thời gian hơn sẽ chỉ tính phí của "<strong>khách hàng thân thiết</strong>".
                    </blockquote>
                    <p></p>
                    <img class="format" src="/images/icon-grow-1.png" alt="thiết kế Website chuẩn seo kiên giang" title="thiết kế Website chuẩn seo kiên giang" style="box-shadow:none;">
                </div>
            </div>
        </div>  
    </div>
