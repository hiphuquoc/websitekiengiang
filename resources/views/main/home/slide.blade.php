<div class="slideBox">
    ...
    <video class="slideBox_video" type="video/mp4" autoplay muted loop><source src="{{ Storage::url('videos/background-slide-25.mp4') }}" title="thiết kế website kiên giang">Video thiết kế website kiên giang</video>
